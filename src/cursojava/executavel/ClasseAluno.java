...
public class ClasseAluno {
    ...
    public static void main(String[] args) {
        ...
        while (opcaoEscolha != 0) {
            opcaoEscolha = Integer.parseInt(JOptionPane.showInputDialog("Escolha uma das Opções (1-Novo Aluno, 2-Remover Aluno, 3-Alterar nome do Aluno, 4-Remover Disciplina, 5-Listar Alunos e 0-Sair) ?"));
